...
This document is a guide to contributing to proximal
...
## Building proximal from source

You'll need to build proximal locally in order to start editing code.

To install proximal from source, clone the GitHub
...
To contribute to proximal, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the proximal
...
If you'd like to add a new feature to proximal, please do propose your
...
- Read the proximal source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/proximal/issues),
...
proximal tests live in the directory `tests`,
